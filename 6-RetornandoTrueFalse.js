...
true se pelo menos um desenvolvedor Ruby se inscreveu ou false se não houver desenvolvedores Ruby.
...
const isRubyComing = (arr) => arr.some((item) => item.language === 'Ruby');
